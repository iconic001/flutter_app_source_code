...
class AppConfig {
  static String copyright_text = "@ Mwachaka Group Limited " + this_year; //this shows in the splash screen
  static String app_name = "MGL"; //this shows in the splash screen
  static String purchase_code = "5332a777-6be6-40a4-9ef9-737c9d24ef49"; //enter your purchase code for the app from codecanyon
  ...
  //configure this
  static const DOMAIN_PATH = "mwachaka.com"; //localhost
